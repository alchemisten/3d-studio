...
import { ExpoRenderService } from '@alchemisten/3d-studio-expo';
...
const launcher = new ViewerLauncher({ render: ExpoRenderService });

export const App = () => {
  const [, setViewer] = useState<IViewer>();
  const onContextCreate = (gl: ExpoWebGLRenderingContext) => {
    setViewer(launcher.createCanvasViewer(config, gl));
  };
